...
Este template permite crear fulfillments para Chatbots en Cliengo utilizando AWS y Serverless, con Node.js.

# Cliengo Chatbot Fulfillment Serverless Framework Node REST API on AWS
